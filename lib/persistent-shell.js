...
(function() {
  var EventEmitter, PersistentShell, typeIsArray,
  ...
  PersistentShell = (function(superClass) {
    extend(PersistentShell, superClass);

    PersistentShell.prototype.host = {};

    PersistentShell.prototype.command = "";

    PersistentShell.prototype._stream = {};

    PersistentShell.prototype._data = "";

    PersistentShell.prototype._buffer = "";

    PersistentShell.prototype._firstPrompt = true;

    PersistentShell.prototype._asciiFilter = "";

    PersistentShell.prototype._textColorFilter = "";

    PersistentShell.prototype._pipes = [];

    PersistentShell.prototype._processData = function(data) {
      ...
      if (!this._firstPrompt && this.standardPromt.test(this._buffer.replace(this.command.substr(0, this._buffer.length), ""))) {
        ...
        if (typeIsArray(this.host.commands) && this.host.commands.length > 0) {
          if (this.host.debug) {
            this.emit('info', this.host.server.host + ": First prompt run commands");
          }
          return this._nextCommand();
        }
      } else {
        return this.emit('commandProcessing', this.command, this._buffer);
      }
    };

    PersistentShell.prototype._commandComplete = function() {
      var response;
      ...
      if (typeIsArray(this.host.commands) && this.host.commands.length > 0) {
        if (this.host.debug) {
          this.emit('info', this.host.server.host + ": Command complete run commands");
        }
        return this._nextCommand();
      } else {
        return this.emit('lastCommand', this.command);
      }
    };

    PersistentShell.prototype._nextCommand = function() {
      var command;
      if (this.host.verbose) {
    ...
    PersistentShell.prototype.runCommand = function(command) {
      if (typeIsArray(command)) {
        this.host.commands = command;
        return this._nextCommand;
      } else if (command === '\x03') {
        if (this.host.debug) {
          this.emit('info', this.host.server.host + ": sending ctrl-c");
        }
        return this._stream.write('\x03');
      } else {
        if (command.indexOf("exit") > -1) {
          if (this.host.debug) {
            this.emit('info', this.host.server.host + ": exiting");
          }
          this.exit();
        }
        if (this.host.verbose) {
        ...
        return this._stream.write("" + this.command + this.host.enter);
      }
    };

    PersistentShell.prototype.exit = function() {
      if (this.host.debug) {
    ...
    PersistentShell.prototype._loadDefaults = function() {
      var ref;
      ...
      if (this.host.callback) {
        return this._callback = this.host.callback;
      }
    };

    function PersistentShell(host) {
      this.host = host;
    ...
    PersistentShell.prototype._initiate = function() {
      var ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
      if (this.host.debug) {
        this.emit('info', this.host.server.host + ": initiate");
      }
      this._loadDefaults();
      this.on("firstPrompt", (ref = this.host.onFirstPrompt) != null ? ref : (function(_this) {
        return function() {
          if (_this.host.debug) {
            return _this.emit('info', _this.host.server.host + ": Class.shell ready");
          }
        };
      })(this));
      this.on("commandProcessing", (ref1 = this.host.onCommandProcessing) != null ? ref1 : (function(_this) {
        return function(response) {
          if (_this.host.debug) {
            return _this.emit('info', _this.host.server.host + ": Class commandProcessing");
          }
        };
      })(this));
      this.on("commandComplete", (ref2 = this.host.onCommandComplete) != null ? ref2 : (function(_this) {
        return function(response) {
          if (_this.host.debug) {
      ...
      this.on("lastCommand", (ref3 = this.host.onLastCommand) != null ? ref3 : (function(_this) {
        return function(command) {
          if (_this.host.debug) {
            return _this.emit('info', _this.host.server.host + ": Class.lastCommand");
          }
        };
      })(this));
      this.on("end", (ref4 = this.host.onEnd) != null ? ref4 : (function(_this) {
      ...
      this.on("keyboard-interactive", (function(_this) {
        return function(name, instructions, instructionsLang, prompts, finish) {
          ...
          if (_this.host.verbose) {
            ...
            _this.emit('info', "Prompts object: " + str);
          }
          if (_this.host.onKeyboardInteractive) {
            return _this.host.onKeyboardInteractive(name, instructions, instructionsLang, prompts, finish);
          }
        };
      })(this));
      this.on("msg", (ref5 = this.host.msg) != null ? ref5 : (function(_this) {
        return function(message) {
          return process.stdout.write(message);
        };
      })(this));
      this.on("info", (function(_this) {
        return function(message) {
          return _this.emit('msg', message + _this.host.enter);
        };
      })(this));
      this.on("error", (ref6 = this.host.onError) != null ? ref6 : (function(_this) {
      ...
      this.on("pipe", (ref7 = this.host.onPipe) != null ? ref7 : (function(_this) {
        return function(writable) {
          if (_this.host.debug) {
            _this.emit('info', _this.host.server.host + ": Class.pipe");
          }
          _this._pipes.push(writable);
          return _this;
        };
      })(this));
      this.on("unpipe", (ref8 = this.host.onUnpipe) != null ? ref8 : (function(_this) {
        return function(writable) {
          if (_this.host.debug) {
      ...
      this.on("data", (ref9 = this.host.onData) != null ? ref9 : (function(_this) {
      ...
      return this.on("stderrData", (ref10 = this.host.onStderrData) != null ? ref10 : (function(_this) {
        return function(data) {
    ...
    PersistentShell.prototype.connect = function(callback) {
      if (!callback) {
    ...
    PersistentShell.prototype._connect = function() {
      var e;
