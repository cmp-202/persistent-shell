...
(function() {
  ...
  PersistentShell = (function(superClass) {
    ...
    PersistentShell.prototype._initiate = function() {
      ...
      this.on("end", (ref3 = this.host.onEnd) != null ? ref3 : (function(_this) {
      ...
      this.on("msg", (ref4 = this.host.msg) != null ? ref4 : (function(_this) {
      ...
      this.on("error", (ref5 = this.host.onError) != null ? ref5 : (function(_this) {
      ...
      this.on("pipe", (ref6 = this.host.onPipe) != null ? ref6 : (function(_this) {
      ...
      this.on("unpipe", (ref7 = this.host.onUnpipe) != null ? ref7 : (function(_this) {
        return function(writable) {
          if (_this.host.debug) {
      ...
      this.on("data", (ref8 = this.host.onData) != null ? ref8 : (function(_this) {
      ...
      return this.on("stderrData", (ref9 = this.host.onStderrData) != null ? ref9 : (function(_this) {
        return function(data) {
