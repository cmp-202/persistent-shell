...
(function() {
  ...
  PersistentShell = (function(superClass) {
    ...
    PersistentShell.prototype.pipe = function(writable) {
      this._pipes.push(writable);
      return this;
    };
    ...
    PersistentShell.prototype._loadDefaults = function() {
      ...
      return this.on("end", (ref3 = this.host.onEnd) != null ? ref3 : (function(_this) {
    ...
    PersistentShell.prototype._initiate = function() {
      ...
      this.on("error", (ref1 = this.host.onError) != null ? ref1 : (function(_this) {
      ...
      this.on("firstPrompt", (ref2 = this.host.onFirstPrompt) != null ? ref2 : (function(_this) {
        return function() {
          if (_this.host.debug) {
