...
(function() {
  ...
  SSH2Shell = (function(superClass) {
    ...
    SSH2Shell.prototype._initiate = function() {
      ...
      this.on("pipe", (ref2 = this.host.onPipe) != null ? ref2 : (function(_this) {
      ...
      this.on("unpipe", (ref3 = this.host.onUnpipe) != null ? ref3 : (function(_this) {
        return function(source) {
          if (_this.host.debug) {
      ...
      this.on("data", (ref4 = this.host.onData) != null ? ref4 : (function(_this) {
      ...
      return this.on("stderrData", (ref5 = this.host.onStderrData) != null ? ref5 : (function(_this) {
        return function(data) {
